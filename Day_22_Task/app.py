...
API_KEY = "ac4ddef925f3eefe6ea4b51da546ec70"  # Replace this with your actual API key
...
"""
                # Save to file
                with open("Day_22_Task/weather_data.txt", "w") as file:
                    file.write(weather_str)

                st.success("✅ Weather data saved to file.")
                with open("Day_22_Task/weather_data.txt", "rb") as file:
